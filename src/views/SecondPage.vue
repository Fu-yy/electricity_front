<template>
  <div>
      <el-row :gutter="20">
      <el-col :span="6">
        <div id="secondPage_myChart1" :style="{width: '100%', height: '200px'}"></div>
      </el-col>
      <el-col :span="12">
                <div id="secondPage_myChart2" :style="{width: '100%', height: '500px'}"></div>

      </el-col>
      <el-col :span="6">
        <div id="secondPage_myChart3" :style="{width: '100%', height: '200px'}"></div>
      </el-col>
    </el-row>
  </div>
</template>
...
methods:{
  drawChart2(){
    let secondPage_myChart2 = this.$echarts.init(document.getElementById("secondPage_myChart2"));
